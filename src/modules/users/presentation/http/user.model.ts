...
import { DepartmentSchema } from 'src/modules/departments/department.model';
...
export const UserPublicSchema = UserSchema.omit({
  ...
  roleId: z.number().positive().nullable().optional(),
  departmentId: z.number().positive().nullable().optional(),
});

export const UserDetailSchema = UserPublicSchema.extend({
