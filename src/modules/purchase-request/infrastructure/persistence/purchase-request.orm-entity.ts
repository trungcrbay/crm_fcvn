...
@Index(['departmentId'])
@Index(['createdById'])
export class PurchaseRequestOrmEntity extends BaseEntity {
  ...
  @OneToMany(
    ...
    (item: PurchaseRequestItemOrmEntity) => item.purchaseRequest,
    {
      cascade: false,
    },
  )
  ...
  @OneToMany(
    ...
    (history: PurchaseRequestHistoryOrmEntity) => history.purchaseRequest,
    {
      cascade: false,
    },
  )
  histories: PurchaseRequestHistoryOrmEntity[];
}
